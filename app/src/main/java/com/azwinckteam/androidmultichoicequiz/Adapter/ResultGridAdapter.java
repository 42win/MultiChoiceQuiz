...
import com.azwinckteam.androidmultichoicequiz.R;
...
public class ResultGridAdapter extends RecyclerView.Adapter<ResultGridAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.btn_question.setText(new StringBuilder("Question").append(currentQuestionList.get(i).getQuestionIndex()+1));
        ...
        {
            myViewHolder.btn_question.setBackgroundColor(Color.parseColor("#11e9ed"));
